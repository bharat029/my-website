...
import { WorkExperience, Hackathon, VolunteerExperience } from 'src/app/store/cv/cv.model';
import { Content, Course, Project, Specialization } from 'src/app/store/root/root.model';
import { FormType } from '../form.models';

interface DialogData {
  edit: boolean, 
  type: FormType, 
  data?: Content | Project | Course | Specialization | WorkExperience | Hackathon | VolunteerExperience,
};
